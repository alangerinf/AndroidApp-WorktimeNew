package com.ibao.alanger.worktimecopa.views.main.fragments;
...
import com.ibao.alanger.worktimecopa.views.main.RViewAdapterMainListTareo;
import com.ibao.alanger.worktimecopa.views.tareo.TareoActivity;

import java.util.List;

import static com.ibao.alanger.worktimecopa.views.CreateTareoActivity.MODE_MAIN;
import static com.ibao.alanger.worktimecopa.views.CreateTareoActivity.EXTRA_MODE;
import static com.ibao.alanger.worktimecopa.views.tareo.TareoActivity.EXTRA_TAREO;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link DirectTareoFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DirectTareoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DirectTareoFragment extends Fragment {
    ...
    public DirectTareoFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static DirectTareoFragment newInstance(String param1, String param2) {
        DirectTareoFragment fragment = new DirectTareoFragment();
    ...
    void declaration(){
        ...
        tareoVOList = new TareoDAO(ctx).listDirectos();

        tViewTittle = getView().findViewById(R.id.fmain_tViewTittle);
        tViewTittle.setText("Lista de Labores Directas");
