package com.ibao.alanger.worktimecopa.update;
...
import com.ibao.alanger.worktimecopa.database.webserver.read.Downloader;
import com.ibao.alanger.worktimecopa.database.webserver.read.DownloaderActividades;
import com.ibao.alanger.worktimecopa.database.webserver.read.DownloaderCentroCostes;
import com.ibao.alanger.worktimecopa.database.webserver.read.DownloaderCultivos;
import com.ibao.alanger.worktimecopa.database.webserver.read.DownloaderEmpresas;
import com.ibao.alanger.worktimecopa.database.webserver.read.DownloaderFundos;
import com.ibao.alanger.worktimecopa.database.webserver.read.DownloaderLabores;
import com.ibao.alanger.worktimecopa.database.webserver.read.DownloaderLotes;
import com.ibao.alanger.worktimecopa.database.webserver.read.DownloaderTrabajadores;
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            for (Downloader downloader : DOWNLOADERS){ // recorre cada uno de los downloaders
                ...
                while(downloader.getStatus()!=ConectionConfig.STATUS_FINISHED){ // no corre al siguiente si no acaba esto
                    ...
                    if(downName.equals(DownloaderLabores.class.getSimpleName())){
                        INPROGESS_NAME="Labores";
                        continue;
                    }
