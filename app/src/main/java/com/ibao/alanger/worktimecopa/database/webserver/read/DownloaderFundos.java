...
import com.ibao.alanger.worktimecopa.models.DAO.FundoDAO;
...
import static com.ibao.alanger.worktimecopa.database.DataBaseDesign.TAB_FUNDO;
import static com.ibao.alanger.worktimecopa.database.DataBaseDesign.TAB_FUNDO_COD;
import static com.ibao.alanger.worktimecopa.database.DataBaseDesign.TAB_FUNDO_ID;
import static com.ibao.alanger.worktimecopa.database.DataBaseDesign.TAB_FUNDO_IDEMPRESA;
import static com.ibao.alanger.worktimecopa.database.DataBaseDesign.TAB_FUNDO_NAME;
import static com.ibao.alanger.worktimecopa.database.DataBaseDesign.TAB_FUNDO_STATUS;
import static com.ibao.alanger.worktimecopa.database.webserver.ConectionConfig.URL_DOWN_FUNDOS;


public class DownloaderFundos implements Downloader{

    Context ctx;

    public static int STATUS;

    public static String TAG = DownloaderFundos.class.getSimpleName();

    public DownloaderFundos(Context ctx){
